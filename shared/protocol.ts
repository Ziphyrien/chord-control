...
export type PluginStatus = "active" | "update" | "paused" | "error" | "idle";
...
export type ControllerCommand =
  ...
  | { type: "install" | "remove_plugin" | "plugin_ui"; pluginId: string }
...
export type ControllerEvent =
  ...
  | { type: "response"; id: string; ok: boolean; result?: Json; message?: string }
  | { type: "error"; message: string }
  | { type: "plugin_window"; pluginId: string; title: string; url?: string; visible: boolean }
  | { type: "disconnected"; message: string };
export const defaultSettings = (): ControllerSettings => ({
